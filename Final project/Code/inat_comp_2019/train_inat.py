...
class Params:
    ...
    resume = './model_best.pth.tar'  # set this to path of model to resume training
    #resume = '/media/xuke/C14D581BDA18EBFA/Kaggle/inaturalist-2019-fgvc6/model_best.pth.tar'
    #train_file = '/media/xuke/C14D581BDA18EBFA/Kaggle/inaturalist-2019-fgvc6/train2019.json'
    #val_file = '/media/xuke/C14D581BDA18EBFA/Kaggle/inaturalist-2019-fgvc6/val2019.json'
    #data_root = '/media/xuke/C14D581BDA18EBFA/Kaggle/inaturalist-2019-fgvc6/'
    train_file = '../train2019.json'
    val_file = '../val2019.json'
    data_root = '../'
    # set evaluate to True to run the test set
    evaluate = False#True# False
    save_preds = True
    op_file_name = 'inat2019_test_preds.csv' # submission file
    if evaluate == True:
...
def main():
    ...
    #model = inception_v3(pretrained=True)#inception_v3(pretrained=True)
